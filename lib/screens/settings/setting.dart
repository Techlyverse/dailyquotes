...
class _SettingScreenState extends State<SettingScreen> {
  ...
  String _selectedLanguage = 'Select Language'; // Default display
  ...
  Future<List<String>> getLanguages() async {
    try {
      // final langs = await Preferences.getLanguages();
      // debugPrint('Stored languages: $langs');
              ...
              trailing: PopupMenuButton<String>(
                onSelected: (String value) {
                  setState(() {
                    ...
                    Preferences.saveLanguages(value);
